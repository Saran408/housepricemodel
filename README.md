...
```
## OUTPUT:
![output](./static/img/housetrain.png)

![output](./static/img/housepred.png)

## CODE VALIDATION REPORT:
![output](./static/img/htvali.png)

![output](./static/img/hpvali.png)

## RESULT:
Thus a website is designed to train the house price modeland to predict the price and is hosted in the URL http://saran.student.saveetha.in:8000/HouseModelTraining/ and http://saran.student.saveetha.in:8000/HouseModelPrediction/ HTML code is validated.